...
export default function Footer(props) {
	...
	return (
		<footer className="py-6  text-white mt-10 " style={{ backgroundColor: "rgb(15,20,22)" }}>
			<div className="container px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
				<div className="grid grid-cols-12">
					<div className="pb-6 col-span-full md:pb-0 md:col-span-6">
						<img src={logoImg} width={450} alt="logo" />
					</div>
					<div className="col-span-6 text-center md:text-left md:col-span-3">
						<p className="pb-1 text-lg text-center font-medium">PARTNER</p>
						<div className="grid grid-cols-3 gap-10">
							{arrHeThongRap.map((rapChieu, index) => {
								return (
									<div key={index}>
										<img width={75} src={rapChieu.logo} alt="" />
									</div>
								);
							})}
						</div>
